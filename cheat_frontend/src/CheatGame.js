...
export default function CheatGame({
    ...
    const addStatusMessage = (playerId, message, is_play_announcement = false) => {
        ...
        if (playerElement) {
            ...
            const newMessage = {
                id: Math.random(), playerId, message, position, is_play_announcement
            };
    ...
    }, [messageInput, socket, state?.your_id]);
