    ...
    return (<div
        ...
        <div className="relative w-full max-w-md h-96 mx-auto z-10">
            ...
            <div className={`
                    ...
                    ${animationPhase === 'form-visible' ? `flex-1 justify-start ${showJoinForm ? '-translate-y-[45%]' : '-translate-y-[32%]'}` : 'flex-0'}
                `} style={{transitionDuration: '1100ms'}}>

                {/* New Game form*/}
                {animationPhase === 'form-visible' && !showJoinForm && (

                    <div className="rounded-2xl bg-white max-w-md w-full shadow-2xl">
                                ...
                                <div className="mb-6">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div style={{
                                                paddingLeft: `${botPadding}px`, paddingRight: `${botPadding}px`
                                            }}>
                                                <input
                                                    type="range"
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="px-8 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-bold py-3 rounded-lg transition-colors whitespace-nowrap"
                                    >
                                        Join
                                    </button>
                                </div>
