			...
			<div className="relative w-full max-w-md h-96 mx-auto">
				...
				<div className={`
					...
					${animationPhase === 'drawing' 
						? 'absolute top-1/4 left-1/2 transform -translate-x-1/2' // Centered
						: animationPhase === 'moving-up'
						? 'absolute top-1/4 left-1/2 transform -translate-x-1/2'   // Moving to top
				...
				<div className={`
					...
					${animationPhase === 'form-visible' 
						? 'opacity-100 absolute top-5 mt-5 left-1/2 transform -translate-x-1/2 -translate-y-0 drop-shadow-lg'  // Visible and in position
